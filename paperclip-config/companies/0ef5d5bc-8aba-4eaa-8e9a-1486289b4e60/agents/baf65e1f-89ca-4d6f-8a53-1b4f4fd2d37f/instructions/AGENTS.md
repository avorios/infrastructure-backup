...
3. Download any attached RFP PDF to `/Users/ivoryrobinson/erate-workspace/rfps/`
4. If CSV data is available, run the parse script to generate a preliminary brief
5. Report status via issue comments and hand off to 470 Analyst
